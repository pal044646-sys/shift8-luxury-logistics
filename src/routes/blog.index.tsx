...
export const Route = createFileRoute("/blog/")({
  head: () => {
    ...
    const description =
      "Practical moving advice from SHIFT8 movers and packers — India-wide pricing guides, packing checklists, and intercity route insights.";
    return {
      meta: [
        { title },
      ...
      <section className="pt-28 sm:pt-36 pb-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <SectionTitle
            ...
            subtitle="Honest, useful advice from crews that move families across India."
          />
            ...
            {BLOG_POSTS.map((post) => (
              ...
              >
                <div className="flex items-center gap-3 text-xs text-foreground/55 mb-3">
                  ...
                  <span className="inline-flex items-center gap-1">
                    <Clock size={12} /> {post.minutes} min read
                  </span>
                </div>
                <h2 className="font-display text-xl text-foreground group-hover:text-gold transition mb-2">
                  {post.title}
                </h2>
