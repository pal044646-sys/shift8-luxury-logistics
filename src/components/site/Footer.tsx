...
export function Footer() {
  return (
    <footer id="contact" className="border-t border-gold/15 mt-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-sm text-foreground/65 leading-relaxed">
              Haridwar's premium movers & packers. Moving India, one shift at a time.
            </p>
          </div>
          <div>
            <h4 className="text-gold uppercase tracking-widest text-xs mb-4">Contact</h4>
            <ul className="space-y-2 text-sm text-foreground/80">
              <li className="flex items-center gap-2"><Phone size={14} className="text-gold" /> +91 8439975345</li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-foreground/75">
              ...
              <li><a href="#quote" className="hover:text-gold">Get Quote</a></li>
            </ul>
          </div>
        </div>
      ...
      <a
        ...
        aria-label="WhatsApp"
        className="fixed bottom-5 right-5 z-40 w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-2xl hover:scale-110 transition"
      >
